#ifndef ROBOT_MODE_METHOD_H
#define ROBOT_MODE_METHOD_H
...
class RobotModeMethod : public XmlRpc::XmlRpcServerMethod {
private:
...
public:
    RobotModeMethod(XmlRpc::XmlRpcServer* server,
                      SessionManager& sm,
                      PALogger& L,
                      RobotService& rs);
